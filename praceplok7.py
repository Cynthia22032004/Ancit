...
# ==== 1. Baca Gambar ====
img = cv2.imread(r'C:\Users\yayuk\Documents\Semester 6\Analisis citra\UTS\image\ceplok7.jpg')
...
cv2.imwrite(r'C:\Users\yayuk\Documents\Semester 6\Analisis citra\UTS\image\resized_ceplok7.jpg', resized_img)
print("Gambar berhasil di-resize.")

# ==== 3. Normalisasi Warna (RGB jadi 0–1) ====
normalized_img = resized_img / 255.0
normalized_save = (normalized_img * 255).astype('uint8') 
cv2.imwrite(r'C:\Users\yayuk\Documents\Semester 6\Analisis citra\UTS\image\normalized_ceplok7.jpg', normalized_save)
print("Normalisasi warna selesai.")

# ==== 4. Konversi ke Grayscale ====
gray_img = cv2.cvtColor(resized_img, cv2.COLOR_BGR2GRAY)
cv2.imwrite(r'C:\Users\yayuk\Documents\Semester 6\Analisis citra\UTS\image\gray_ceplok7.jpg', gray_img)
